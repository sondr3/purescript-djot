...
getAttributes ∷ ∀ a. HasAttributes a → Attributes
...
insertAttribute ∷ ∀ a. HasAttributes a → String → (String → String) → HasAttributes a
...
type HTMLRenderer =
  { renderChildren ∷ ∀ t a. HasChildren t a → String
  , renderAstNodeDefault ∷ ∀ a. HasAttributes a → String
  }

foreign import renderWarning_ ∷ Warning → String

foreign import buildOverridesImpl ∷ ∀ a. Fn2 (Maybe a → Boolean) (Visitor HTMLRenderer String) (Visitor HTMLRenderer String)

buildOverrides ∷ Visitor HTMLRenderer String → Visitor HTMLRenderer String
buildOverrides = runFn2 buildOverridesImpl isJust

foreign import renderHtmlImpl ∷ ∀ a. Fn3 (Maybe a → Boolean) Doc (Maybe RenderHTMLOptions) String
